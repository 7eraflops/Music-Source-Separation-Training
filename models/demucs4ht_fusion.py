...
class FusionHTDemucs(nn.Module):
    """
    Spectrogram and hybrid Demucs model with Latent Fusion.
    """
...
def get_model(args):
    ...
    if args.model == "htdemucs_fusion":
        ...
        # For now, let's grab what we can from args.htdemucs_fusion if it exists, else defaults
